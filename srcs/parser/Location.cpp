...
/*   Updated: 2023/04/08 17:44:08 by cjulienn         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
_index(std::vector<std::string>()), _url(std::string())
{
...
_root(original._root), _autoindex(original._autoindex), _index(original._index), _url(original._url) {}
